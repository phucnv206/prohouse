                ...
                <div class="col-md-7 col-xs-12 head-left">
                    <ul>
                        <?php foreach ($categories = Helpers::listCategories() as $i => $category): ?>
                            <?php if ($i <= 4): ?>
                                <li>
                                    <?=Html::a($category->details[0]->title, ['category/index', 'id' => $category->id, 'title' => Helpers::getSlug($category->details[0]->title)])?>
                                ...
                                <?php if ($i === 5): ?>
                                    <li>
                                        <div class="dropdown">
                                            ...
                                            <?php endif?>
                                            <li><?=Html::a($category->details[0]->title, ['category/index', 'id' => $category->id, 'title' => Helpers::getSlug($category->details[0]->title)])?></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7  main-menu pull-right" id='cssmenu'>
                    <ul>
                        <li>
                            <a title="<?=Yii::t('app', 'Apartment')?>" href="<?=Url::to(['site/search', 'type' => Product::TYPE_APARTMENT, 'title' => Helpers::getSlug(Yii::t('app', 'Apartment'))])?>"><?=Yii::t('app', 'Apartment')?></a>
                        </li>
                        <li>
                            <a title="<?=Yii::t('app', 'House')?>" href="<?=Url::to(['site/search', 'type' => Product::TYPE_HOUSE, 'title' => Helpers::getSlug(Yii::t('app', 'House'))])?>"><?=Yii::t('app', 'House')?></a>
                        </li>
                        <li>
                            <a title="<?=Yii::t('app', 'Office')?>" href="<?=Url::to(['site/search', 'type' => Product::TYPE_OFFICE, 'title' => Helpers::getSlug(Yii::t('app', 'Office'))])?>"><?=Yii::t('app', 'Office')?></a>
                        </li>
                        <li>
                            <a title="<?=Yii::t('app', 'For lease')?>" href="<?=Url::to(['site/search', 'for' => Product::FOR_RENT, 'title' => Helpers::getSlug(Yii::t('app', 'For lease'))])?>"><?=Yii::t('app', 'For lease')?></a>
                        </li>
                        <li>
                            <a title="<?=Yii::t('app', 'For sales')?>" href="<?=Url::to(['site/search', 'for' => Product::FOR_SALE, 'title' => Helpers::getSlug(Yii::t('app', 'For sales'))])?>"><?=Yii::t('app', 'For sales')?></a>
                        </li>
                        <li style="position: relative" class="legal-btn">
                            ...
                            <div class="legal-dropdown">
                                ...
                                <a href="<?=Url::to(['legal/index', 'id' => $legal->id, 'title' => Helpers::getSlug($legal->details[0]->title)])?>">
