    ...
    <div class="tab-content">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <?=$form->field($model, 'for')->dropdownList(Helpers::getFor(), ['class' => 'form-control for-dropdown'])?>
                    </div>
                    <div class="col-md-6 pricetype-dropdown-wrapper" <?=$model->for == 0 ? '' : 'style="display: none"'?>>
                        <?=$form->field($model, 'price_type')->dropdownList(Helpers::getPriceType())?>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
